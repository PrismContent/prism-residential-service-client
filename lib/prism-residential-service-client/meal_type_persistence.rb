    ...
    class << self
      ...
      def save(meal_type)
        ...
        if response.timed_out?
          meal_type.send("service_errors=".to_sym, "Connection timeout. Please try again soon.")
          return false
        end
        ...
        case response.code
          ...
          when 201
            ...
            return true
          when 0 
            meal_type.send("service_errors=".to_sym, "Unable to connect to service. Please try again soon.")
            return false  
          else
